...
func (_m *Validator) Validate(value any) error {
	ret := _m.Called(value)
...
//   - value any
func (_e *Validator_Expecter) Validate(value any) *Validator_Validate_Call {
	return &Validator_Validate_Call{Call: _e.mock.On("Validate", value)}
}

func (_c *Validator_Validate_Call) Run(run func(value any)) *Validator_Validate_Call {
...
func (_c *Validator_Validate_Call) RunAndReturn(run func(any) error) *Validator_Validate_Call {
	_c.Call.Return(run)
	return _c
}
